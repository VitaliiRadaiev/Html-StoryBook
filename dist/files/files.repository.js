...
let FilesRepository = class FilesRepository {
    ...
    createFile(_a) {
        return __awaiter(this, arguments, void 0, function* ({ url, type, body }) {
            return yield this.prismaService.client.fileModel.create({
                data: {
                    url,
                    type,
    ...
    getFileById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.client.fileModel.findFirst({
                where: { id }
            });
        });
    }
    deleteFile(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.prismaService.client.fileModel.delete({
                where: { id }
            });
        });
    }
