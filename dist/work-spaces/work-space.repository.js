...
let WorkSpaceRepository = class WorkSpaceRepository {
    ...
    createWorkSpace(_a) {
        return __awaiter(this, arguments, void 0, function* ({ title }) {
            const count = yield this.prismaService.client.workSpaceModel.count();
    ...
    updateWorkSpace(id_1, _a) {
        return __awaiter(this, arguments, void 0, function* (id, { title, order, scss, js }) {
    ...
    deleteWorkSpace(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.prismaService.client.workSpaceModel.delete({
                where: {
                    id
                }
            });
    ...
    createLink(workspaceId_1, _a) {
        return __awaiter(this, arguments, void 0, function* (workspaceId, { url, workspaceCssId, workspaceJsId }) {
...
//# sourceMappingURL=work-space.repository.js.map