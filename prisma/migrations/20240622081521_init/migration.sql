/*
  ...
  - You are about to drop the column `css` on the `ComponentModel` table. All the data in the column will be lost.
  - You are about to drop the column `css` on the `WorkSpaceModel` table. All the data in the column will be lost.
